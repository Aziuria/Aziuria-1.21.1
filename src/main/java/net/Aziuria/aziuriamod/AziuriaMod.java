...
import net.Aziuria.aziuriamod.handler.armor.ArmorTrimHandler;
import net.Aziuria.aziuriamod.handler.armor.CopperArmorLightningHandler;
import net.Aziuria.aziuriamod.handler.blocks.BlockDropHandler;
import net.Aziuria.aziuriamod.handler.blocks.CopperBarsInteractionHandler;
import net.Aziuria.aziuriamod.handler.blocks.FastLeafDecayHandler;
import net.Aziuria.aziuriamod.handler.custom.*;
import net.Aziuria.aziuriamod.handler.items.BaitedFishingHandler;
import net.Aziuria.aziuriamod.handler.items.FishingRodCraftingHandler;
import net.Aziuria.aziuriamod.handler.items.FishingRodHandler;
import net.Aziuria.aziuriamod.handler.particles.LeafParticleHandler;
...
import net.Aziuria.aziuriamod.hud.exhaustion.capability.ExhaustionHudOverlay;
import net.Aziuria.aziuriamod.hud.exhaustion.capability.ExhaustionProvider;
import net.Aziuria.aziuriamod.hud.exhaustion.handler.*;
import net.Aziuria.aziuriamod.hud.exhaustion.network.ExhaustionNetworkHandler;
import net.Aziuria.aziuriamod.hud.exhaustion.registry.ExhaustionSetup;
...
import net.Aziuria.aziuriamod.hud.creative.ModCreativeModeTabs;
...
import net.Aziuria.aziuriamod.hud.thirst.capability.ThirstHudOverlay;
...
public class AziuriaMod {
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ...
            Regions.register(new ModOverworldRegion(ResourceLocation.fromNamespaceAndPath(MOD_ID, "overworld"), 2));

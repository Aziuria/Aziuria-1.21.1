...
public class ModDataMapProvider extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        this.builder(NeoForgeDataMaps.COMPOSTABLES)
                ...
                .add(ModItems.BLACKCURRANT_SEEDS.getId(), new Compostable(0.45f), false)
                ...
                .add(ModBlocks.PEAR_LEAVES.getId(), new Compostable(0.45f), false)
                .add(ModBlocks.PEAR_SAPLING.getId(), new Compostable(0.45f), false)
                .add(ModBlocks.CHERRY_LEAVES.getId(), new Compostable(0.45f), false)
                .add(ModBlocks.CHERRY_SAPLING.getId(), new Compostable(0.45f), false)

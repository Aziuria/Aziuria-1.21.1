...
public class ModBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(ModBlocks.WEATHERED_COPPER_BARREL.get())
                .add(ModBlocks.OXIDIZED_COPPER_BARREL.get())
                .add(ModBlocks.WAXED_COPPER_BARREL.get())
                .add(ModBlocks.WAXED_EXPOSED_COPPER_BARREL.get())
                .add(ModBlocks.WAXED_OXIDIZED_COPPER_BARREL.get())
                .add(ModBlocks.WAXED_OXIDIZED_COPPER_BARREL.get())
        ...
        tag(BlockTags.NEEDS_STONE_TOOL)
                ...
                .add(ModBlocks.WAXED_EXPOSED_COPPER_BARREL.get())
                .add(ModBlocks.WAXED_OXIDIZED_COPPER_BARREL.get())
                .add(ModBlocks.WAXED_WEATHERED_COPPER_BARREL.get())
